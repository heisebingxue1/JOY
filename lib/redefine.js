...
/* 
	If u use /\s+$/ to trim trailing characters, none of big browsers are currently smart enough to 
	realize in advance that this regex can match only at the end of the string.
	each time when whiltespace character is found,
	the regex advance to the next token($), which checks whether the match is at the end of the string,
	if not, it continue to search until the end of the string.
	The longer your string(the more whilespace it contains), the longer this takes.
*/
...
if(!Function.prototype.bind){
  Function.prototype.bind = function(o){
    ...
    return function(){
        return self.apply(o, args.concat(slice.apply(arguments, [0])));
    }
  }
}
...
/*
Another way for redefine forEach
